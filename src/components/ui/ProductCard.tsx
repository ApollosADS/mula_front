...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="bg-gray-50 rounded-lg overflow-hidden shadow-card hover:shadow-xl transition-all duration-300 group">
      {/* Image Section */}
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
             <h4 className="font-bold text-lg text-gray-900 leading-tight w-2/3">
                <Link to={`/product/${product.id}`} className="hover:text-mula-red transition-colors">
                    {product.name}
                </Link>
             </h4>
